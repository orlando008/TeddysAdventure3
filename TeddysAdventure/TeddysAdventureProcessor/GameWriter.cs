...
namespace TeddysAdventureProcessor
{
    public abstract class GameWriter<T> : ContentTypeWriter<T>
    {
        public override string GetRuntimeReader(TargetPlatform targetPlatform)
        {
            ...
            readerText += ", GameLibrary";

            // replace the suffix name on the Xbox 360
            // -- since the processor runs on Windows, it needs to reference 
            //    GameLibrary.  However, this means that type.FullName
            //    will specify MyFirstGame in the interior type of templates
        ...
        public override string GetRuntimeType(TargetPlatform targetPlatform)
        {
            ...
            string typeText = type.FullName + ", GameLibrary";
